...
if !m_editor { if propietario { // comandos movimiento
    ...
    if pantalla != noone {
        if point_distance(x, y, pantalla.x, pantalla.y) > __view_get( e__VW.HView, 0 ) * 0.4 {
            pantalla = noone;
        }
    }
        ...
        switch cerca_esp.object_index {
            ...
            case o_tablero:
                ...
                if pnt != -1 {
                    var ww = ds_grid_width(cerca_esp.imagen);
                    var hh = ds_grid_height(cerca_esp.imagen);
                    var vx = lerp(0, ww, clamp(mous_viejx - __view_get( e__VW.XView, 0 ),
                        0, __view_get( e__VW.WView, 0 )) / __view_get( e__VW.WView, 0 ));
                    var vy = lerp(0, hh, clamp(mous_viejy - __view_get( e__VW.YView, 0 ),
                        0, __view_get( e__VW.HView, 0 )) / __view_get( e__VW.HView, 0 ));
                    var nx = lerp(0, ww, clamp(mouse_x - __view_get( e__VW.XView, 0 ),
                        0, __view_get( e__VW.WView, 0 )) / __view_get( e__VW.WView, 0 ));
                    var ny = lerp(0, hh, clamp(mouse_y - __view_get( e__VW.YView, 0 ),
                        0, __view_get( e__VW.HView, 0 )) / __view_get( e__VW.HView, 0 ));
            ...
            case o_pergamino:
                ...
                if keyboard_check_pressed(ord("1")) {
                    ...
                    if fff != "" {
                        ...
                        file_text_close(tfi);
                        while string_height_ext(string_hash_to_newline(txt), 13, 232 * 1.5) * 0.6 > 172 * 1.5 or
                                string_width_ext(string_hash_to_newline(txt), 13, 232 * 1.5) * 0.6 > 150 * 1.5 {
            ...
            case 148: // camara
                if keyboard_check_pressed(vk_space) {
                    if keyboard_check(vk_control) {
                        ...
                        if point_distance(x, y, en_mira.x, en_mira.y) < __view_get( e__VW.HView, 0 ) * 0.5 {
    ...
    var cy = __view_get( e__VW.YView, 0 ) + __view_get( e__VW.HView, 0 ) / 2 + 32;
    ...
    if vel > 100 {
        ...
        __view_set( e__VW.XView, 0, __view_get( e__VW.XView, 0 ) + (lengthdir_x(vel, direction)) );
        __view_set( e__VW.YView, 0, __view_get( e__VW.YView, 0 ) + (lengthdir_y(vel, direction)) );
        camb = true;
    }
    if camb {
